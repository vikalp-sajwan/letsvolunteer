...
<?php
    $eventid = $_GET['id'];
    $getevents = mysqli_query($connection, "SELECT * FROM coveredevents WHERE eventid=$eventid");
        ...
        $pic2 = $row['pic2'];
        $pic3 = $row['pic3'];
        $submissiondate = strtotime($row['submissiondate']); 
 ...
 if(date("j F Y", $eventstart) == date("j F Y", $eventend)){
    ...
    echo " - ",date("h:i a", $eventend);
        ...
        echo "</b>  <img src='images/$pic1' style='width:100%;height:250px'>";        
        echo "</b>  <p>",$eventintro;
        echo "</b></p>  <img src='images/$pic2' style='width:100%;height:350px'>";
        echo "</b>  <p>",$eventpara;
        echo "</b></p>  <img src='images/$pic3' style='width:100%;height:400px'>";
        echo "</article>";
